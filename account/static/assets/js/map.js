(function($) {
    ...
    L.marker([8.510354859371759, 76.96699583905682], { icon: customIcon }).addTo(cities);

    var mbAttr = 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, ' +
        'Wellco © <a href="https://www.mapbox.com/">Mapbox</a>',
    ...
    var map = L.map('map', {
        center: [8.510354859371759, 76.96699583905682],
        zoom: 15,
        layers: [dark, cities],
